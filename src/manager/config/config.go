...
type ConfigObject struct {
	...
	RunQueueName             string          `json:"run_queue_name" env:"RUN_QUEUE_NAME"`
	...
	WorkerConfig             string          `json:"worker_config" env:"WORKER_CONFIG"`
	K8sNamespace             string          `json:"k8s_namespace" env:"K8S_NAMESPACE"`
}
