		...
		Components: []ui.Component{
			...
			div.Div{
				...
				Components: []ui.Component{
					...
					ui.Raw{
						HTMLString: fmt.Sprintf(`<input style="padding-left:32px;padding-right:32px;" class="w3-input  theme-light" type="text" id="user-add-username" value="%s" disabled>`, username),
					},
					ui.Raw{
						HTMLString: `<label style="padding-left:32px;padding-right:32px;">Password</label>`,
					},
					ui.Raw{
						HTMLString: fmt.Sprintf(`<input style="padding-left:32px;padding-right:32px;" class="w3-input  theme-light" type="password" id="user-add-password" value="%s">`, u.Password),
					},
					ui.Raw{
						HTMLString: `<label style="padding-left:32px;padding-right:32px;">Given Name</label>`,
					},
					ui.Raw{
						HTMLString: fmt.Sprintf(`<input style="padding-left:32px;padding-right:32px;" class="w3-input  theme-light" type="text" id="user-add-given-name" value="%s">`, u.GivenName),
					},
					ui.Raw{
						HTMLString: `<label style="padding-left:32px;padding-right:32px;">Family Name</label>`,
					},
					ui.Raw{
						HTMLString: fmt.Sprintf(`<input style="padding-left:32px;padding-right:32px;" class="w3-input  theme-light" type="text" id="user-add-family-name" value="%s">`, u.FamilyName),
					},
					ui.Raw{
						HTMLString: `<label style="padding-left:32px;padding-right:32px;">Email</label>`,
					},
					ui.Raw{
						HTMLString: fmt.Sprintf(`<input style="padding-left:32px;padding-right:32px;" class="w3-input  dark theme-light" type="text" id="user-add-email" value="%s">`, u.Email),
					},
					ui.Raw{
						HTMLString: `<label style="padding-left:32px;padding-right:32px;">Groups</label>`,
					},
					ui.Raw{
						HTMLString: fmt.Sprintf(`<input style="padding-left:32px;padding-right:32px;" class="w3-input  theme-light" type="text" id="group-tags" value="%s">`, strings.Join(u.Groups, ",")),
					},
					ui.Raw{
						HTMLString: `<label style="padding-left:32px;padding-right:32px;">Roles</label>`,
					},
					ui.Raw{
						HTMLString: fmt.Sprintf(`<input style="padding-left:32px;padding-right:32px;" class="w3-input  theme-light" type="text" id="role-tags" value="%s">`, strings.Join(u.Roles, ",")),
					},
					br.BR{},
					h1.H1{
						Contents: `
			...
			modal.Modal{
				...
				Components: []ui.Component{
					...
					ui.Raw{
						HTMLString: `<input class="w3-input  theme-light" type="text" id="user-generate-api-token-name">`,
					},
					br.BR{},
					card.Card{
						Classes: "ui-green",
