...
func loginBuildPage(errorMessage string, ctx *gin.Context) []byte {
	p := page.Page{
		...
		Components: []ui.Component{
			...
			ui.Raw{
				HTMLString: `
<div class="modal-content dark theme-light animate w3-border w3-border-black w3-card " style="width:40%;margin-left:30%;margin-right:30%;">
<div class="w3-container ui-green ">
	<div class="w3-center">
...
<form class="w3-container" action="/auth/login" id="login_form" method="POST">
	<div class="form-group">
		...
		<input type="text" class="form-control  w3-input dark theme-light" id="username" name="username" placeholder="Username">
	</div>
	<div class="form-group">
		<label for="password" class="label-text ui-text-green">Password</label>
		<input type="password" class="form-control  w3-input dark theme-light" id="password" name="password"
	...
	<br>
	<div>
		<button type="submit" class="w3-button ui-green  diagonal-shadow-grey"><b>Login</b></button>
		<a href="/ui/forgot_password" style="padding-left:8px;">
			<div class="w3-button dark theme-light ui-text-green  ui-border-grey w3-border"><b>Forgot Password</b></div>
		</a>
	</div>
</form>
<br>
