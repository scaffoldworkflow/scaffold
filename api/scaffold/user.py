...
def delete_individual(username: str, base: str, auth: str, fail_on_error: bool=True) -> int:
...
def get_individual(username: str, base: str, auth: str, fail_on_error: bool=True) -> tuple[int, any]:
    headers = {"Authorization" : f'X-Scaffold-API {auth}' }
